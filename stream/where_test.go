...
func TestWhere(t *testing.T) {
	...
	cases := []struct {
		...
		{stream.Equal{Name: "Level", Value: 2}, LogEvent{Level: 1}, false},
		{stream.Equal{Name: "Level", Value: 2}, LogEvent{Level: 2}, true},
		{stream.Equal{Name: "Level", Value: 2}, LogEvent{Level: 3}, false},
		{stream.NotEqual{Name: "Level", Value: 2}, LogEvent{Level: 1}, true},
		{stream.NotEqual{Name: "Level", Value: 2}, LogEvent{Level: 2}, false},
		{stream.NotEqual{Name: "Level", Value: 2}, LogEvent{Level: 3}, true},
